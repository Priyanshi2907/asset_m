...
class AssetMasterAccessories(models.Model):
    ...
    warranty_period = models.DateField(null=True, blank=True, auto_now=False, auto_now_add=False)
...
class AssetMaster(models.Model):
    ...
    #Product engineering support info
    warranty_period = models.DateField(null=True, blank=True,default=None, auto_now=False, auto_now_add=False)
    under_amc = models.BooleanField(default=False)
    amc_date = models.DateField(null=True, blank=True, auto_now=False, auto_now_add=False)
...
class AssetMasterComment(models.Model):
    date_time = models.DateField(null=True, blank=True,auto_now=False, auto_now_add=False)
    asset_id = models.ForeignKey(AssetMaster,on_delete= models.CASCADE,null=True, blank=True)
