...
urlpatterns = [
    ...
    path('edit-sold-detail/<int:id>/', update_sold, name='edit_sold_detail'),
    ...
    #add to order in one go
    path('add-to-order-asset-in-one-go/', add_to_order_in_one_go, name='add_to_order_in_one_go'),
