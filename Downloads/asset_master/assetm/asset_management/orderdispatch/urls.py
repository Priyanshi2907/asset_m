...
urlpatterns = [
    ...
    path('logistic_details/', logisticdetails, name='logistic_details' ),
    ...
    path('send-move-to-inventory-email/', move_to_inventory_email, name='send-move-to-inventory-email'),
